...
Afunction is essentially a set of instructions that takes inputs (arguments), processes them, and returns an output. Instead of writing the same code repeatedly, you can define a function once and use it whenever needed. This makes your scripts cleaner and easier to maintain.

I reccomend Hadley WIckham's great [chapter on functions](https://r4ds.hadley.nz/functions.html) in his book [R for Data Science 2e](https://r4ds.hadley.nz/).
